...
const allProducts = () => {  
  ...
  return (
    <div>
       ...
       <div className={`inset-0 z-50 md:relative md:block md:w-[20%] px-4 md:px-10 border-r border-gray-300 transition-transform duration-300 ease-in-out ${isSidebarOpen ? "block" : "hidden" }md:block `}>
      ...
      <div className="flex flex-wrap items-center justify-between px-4 py-6 md:px-10">
        <div>
          <h1 className="font-[helvetica neue] font-bold h-[27px] text-lg leading-[28px]">New (500)</h1>
        </div>

        <div className="flex items-center space-x-4 md:space-x-6 mt-4 md:mt-0">
          <h6 className="flex items-center gap-2 font-[helvetica neue] text-sm md:text-base">Hide Filters
            <HiOutlineAdjustmentsHorizontal className="my-1 bg-gray-300 w-6 h-6 rounded-full hover:border"/></h6>
          <h6 className="flex items-center gap-2 font-[helvetica neue] text-sm md:text-base">Sort By
      ...
      {/* gender */}
        <div className='mt-4 mb-4'>
          <h2 className='flex justify-between font-semibold mt-2'>Gender
          <IoIosArrowUp /></h2>
        </div>

        <div className='mt-4 mb-4'>
          <label className='flex items-center gap-2'>
            <input type="checkbox" className=' border-gray-400 border-solid w-4 h-4'/>
            <span>Men</span>
          </label>
      ...
      {/* kids */}
        <div className='mt-4 mb-4'>
          <h2 className='flex justify-between font-semibold mt-2'>Kids
          <IoIosArrowUp /></h2>
        </div>
        ...
        {/* shop by price */}
        <div className='mt-4 mb-4'>
          <h2 className='flex justify-between font-semibold mt-2'>Shop By Price
          <IoIosArrowUp /></h2>
        </div>
        ...
        <div className='mt-4 mb-4'>
          <label className='flex items-center gap-2'>
            <input type="checkbox" className=' border-gray-400 border-solid w-4 h-4'/>
            <span className='flex gap-1'>Under<LuIndianRupee className="mr-1 my-1"/>2 500.00</span>
          </label>

          <label className='flex items-center gap-2'>
            <input type="checkbox" className=' border-gray-400 border-solid w-4 h-4'/>
            <span className='flex gap-1'><LuIndianRupee className="mr-1 my-1"/>2 501.00-<LuIndianRupee className="mr-1 my-1"/></span>
          </label>
        </div>

  </div>     

  <div className={` inset-0  z-50 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} transition-transform md:hidden`}>
      ...
      <div data-aos="fade-up">
        ...
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Promo Exclusion</h4>
            <h4 className="font-bold text-sm">Nike Dunk Low Retro SE</h4>
            <p className="text-gray-500">Men's Shoes</p>
            <p className="text-gray-500">1 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>9 695.00</h4>
        </div>
      </div>
      ...
      {/* image 8 */}
      <div data-aos="fade-up">
        <img src="i8.png" alt="Short-Sleeve" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Sustainable Material</h4>
            <h4 className="font-bold text-sm">Nike Dri-FIT UV Hyverse</h4>
            <p className="text-gray-500">Men's Short-Sleeve Graphic Fitness Top</p>
            <p className="text-gray-500">1 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>2 495.00</h4>
        </div>
      </div>
      ...
      <div data-aos="fade-up">
        ...
        <div className="text-start">
            ...
            <p className="text-gray-500">1 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>5 695.00</h4>
        </div>
      </div>
      ...
      {/* image 10 */}
      <div data-aos="fade-up">
        <img src="i10.png" alt="Men's Short-Sleeve" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
      ...
      {/* image 11 */}
      <div data-aos="fade-up">
        <img src="i11.png" alt="Biker Shorts" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
            <h4 className="font-bold text-sm">Nike One Leak Protection: Period</h4>
            <p className="text-gray-500">Women's Mid-Rise 18cm (approx.) Biker Shorts</p>
            <p className="text-gray-500">2 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>3 395.00</h4>
        </div>
      </div>
      ...
      {/* image 12 */}
      <div data-aos="fade-up">
        <img src="i12.png" alt="Kids' Shoe" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
            ...
            <p className="text-gray-500">1 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>7 495.00</h4>
        </div>
      </div>
      ...
      {/* image 13 */}
      <div data-aos="fade-up">
        <img src="i13.png" alt="Women's Shoes" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
            ...
            <p className="text-gray-500">1 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>8 195.00</h4>
        </div>
      </div>
      ...
      {/* image 14 */}
      <div data-aos="fade-up">
        <img src="i14.png" alt="Women's Shoe" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
      ...
      {/* image 15 */}
      <div data-aos="fade-up">
        <img src="i15.png" alt="Sleeveless Top" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
            ...
            <p className="text-gray-500">1 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>1 495.00</h4>
        </div>
      </div>
      ...
      {/* image 16 */}
      <div data-aos="fade-up">
        <img src="i16.png" alt="Men's Shoes" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
      ...
      {/* image 17 */}
      <div data-aos="fade-up">
        <img src="i17.png" alt="Women's Shoes" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
            ...
            <p className="text-gray-500">2 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>5 995.00</h4>
        </div>
      </div>
      ...
      {/* image 18 */}
      <div data-aos="fade-up">
        <img src="i18.png" alt="Running Top" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
            ...
            <p className="text-gray-500">1 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>1 695.00</h4>
        </div>
      </div>
      ...
      {/* image 19 */}
      <div data-aos="fade-up">
        <img src="i19.png" alt="Kids' Shoes" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
            ...
            <p className="text-gray-500">1 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>6 495.00</h4>
        </div>
      </div>
      ...
      {/* image 20 */}
      <div data-aos="fade-up">
        <img src="i20.png" alt="Sports Bra" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
            <h4 className="font-bold text-sm">Nike Alate All U</h4>
            <p className="text-gray-500">Women's Light-Support Lightly Lined U-Neck Printed Sports Bra</p>
            <p className="text-gray-500">1 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>2 195.00</h4>
        </div>
      </div>
      ...
      {/* image 21 */}
      <div data-aos="fade-up">
        <img src="i21.png" alt="Women's Shoes" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
      ...
      <div data-aos="fade-up">
        ...
        <div className="text-start">
            ...
            <p className="text-gray-500">Women's Medium-support Padded Sports Bra Tank</p>
            <p className="text-gray-500">2 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>3 095.00</h4>
        </div>
      </div>
      ...
      <div data-aos="fade-up">
        ...
        <div className="text-start">
            ...
            <p className="text-gray-500">1 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>8 595.00</h4>
        </div>
      </div>
      ...
      {/* image 24 */}
      <div data-aos="fade-up">
        <img src="i24.png" alt="Running Tank" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
            <h4 className="font-bold text-sm">Nike Dri-FIT Run Division Rise 365</h4>
            <p className="text-gray-500">Men's Running Tank</p>
            <p className="text-gray-500">2 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>3 495.00</h4>
        </div>
      </div>
      ...
      {/* image 26 */}
      <div data-aos="fade-up">
        <img src="i26.png" alt="men'sshoes" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
      ...
      {/* image 27 */}
      <div data-aos="fade-up">
        <img src="i27.png" alt="Woven Jacket" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
            <h4 className="font-bold text-sm">Nike Outdoor Play</h4>
            <p className="text-gray-500">Older Kids' Oversized Woven Jacket</p>
            <p className="text-gray-500">1 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>3 895.00</h4>
        </div>
      </div>
      ...
      {/* image 28 */}
      <div data-aos="fade-up">
        <img src="i28.png" alt="Woven Shorts" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
            <h4 className="font-bold text-sm">Nike Sportswear Trend</h4>
            <p className="text-gray-500">Older Kids' (Girls') High-waisted Woven Shorts</p>
            <p className="text-gray-500">2 Colour</p>
            <h4 className="font-bold text-base flex">MRP:
            <LuIndianRupee className="mr-1 my-1"/>2 495.00</h4>
        </div>
      ...
      {/* image 29 */}
      <div data-aos="fade-up">
        <img src="i29.png" alt="Women's Shoes" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
      ...
      {/* image 30 */}
      <div data-aos="fade-up">
        <img src="i30.png" alt="Skate Shoe" className="w-[348px] h-[348px]"/>
        <div className="text-start">
            <h4 className="font-bold text-sm text-red-600">Just In</h4>
      ...
      <div className='mt-12 px-6 md:px-20 lg:px-32'>
        ...
        <div className='flex flex-wrap gap-4 text-sm text-gray-400'>
            ...
            <span className='px-6 py-2 hover:text-gray-600'>Best Selling Products</span>
            <span className='px-6 py-2 hover:text-gray-600'>Best Shoes</span>
            <span className='px-6 py-2 hover:text-gray-600'>New Basketball Shoes</span>
            <span className='px-6 py-2 hover:text-gray-600'>New Football Shoes</span>
            <span className='px-6 py-2 hover:text-gray-600'>New Men's Shoes</span>
            <span className='px-6 py-2 hover:text-gray-600'>New Running Shoes</span>
            <span className='px-6 py-2 hover:text-gray-600'>Best Men's Shoes</span>
            <span className='px-6 py-2 hover:text-gray-600'>New Jordan Shoes</span>
            <span className='px-6 py-2 hover:text-gray-600'>Best Women's Shoes</span>
            <span className='px-6 py-2 hover:text-gray-600'>Best Training & Gym</span>
